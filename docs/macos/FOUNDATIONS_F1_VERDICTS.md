...
- (a) Native `.sheet` + `.presentationSizing(.fitted)` vs MacCard for single modals — INCLUDING the
  present-after-MacCard sequence (the parked Keystone-browser repro) and detent-gotcha check.
