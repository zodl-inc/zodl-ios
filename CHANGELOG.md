...
- [MOB-1962] Coinholder polling picks up a mined vote sooner: the app asks the server that accepted the vote and checks more often, instead of asking every server in turn every two seconds.
