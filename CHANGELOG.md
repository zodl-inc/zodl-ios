...
### Added
- [MOB-1749] When a wallet that already holds Ironwood funds still has a small amount of ZEC sitting in the Orchard pool — less than 0.01 ZEC but more than 0.0001 ZEC, typically after restoring a wallet that was migrated on another device or after moving funds yourself — the home screen now shows a "… ZEC left in Orchard" banner on every start. Tapping More opens a screen that shows what is in Ironwood and what is left in Orchard and lets you lock the leftover balance (recommended: moving an amount that specific could link your Ironwood funds back to your Orchard history) or migrate it anyway. It is the lowest-priority banner the home screen shows: a migration that is still running, a Migration Complete screen you have not reviewed yet, and every other home-screen notice — backing up your wallet, shielding funds, the Tor and currency-conversion prompts — all come first, so a small leftover balance never keeps them off your screen. It disappears by itself once the balance is locked or migrated.
