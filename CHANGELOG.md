...
- [MOB-1810] The polls list opens without waiting for vote-server health checks; checks now run in the background when entering a poll and share submission prefers servers known to be healthy.
