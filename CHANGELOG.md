...
- [MOB-1513] The transfer plan and progress screens now show the balance split as its own immediate step with the correct total amount, and number every transfer.
