...
- [MOB-1755] "Remind me later" on the shielding banner is now respected however the banner would have returned. Dismissing it set a reminder that one route honoured and another ignored, so the banner could come back within minutes of being put off for two days.
