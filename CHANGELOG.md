...
### Fixed
- Coinholder Polling now recovers an ambiguously submitted delegation or vote by checking its exact transaction hash, and reopening a poll preserves persisted delegation setup and completed witness work needed to retry safely.
