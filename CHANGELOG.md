...
### Fixed
- The swap / CrossPay confirmation and the completed swap transaction details now show the correct total service fee (0.67%) instead of an understated 0.5%, matching what is actually charged.
