...
- [MOB-1458] If the migration plan on screen ever goes stale, the app now refreshes it automatically instead of failing the confirmation. Gated behind Ironwood network activation and not yet in a released build.
