...
public enum FontFamily {
  ...
  public enum RobotoMono {
    ...
    public static let semiBold = FontConvertible(name: "RobotoMono-SemiBold", family: "Roboto Mono", path: "RobotoMono-SemiBold.ttf")
...
#else
    let fontSize = self.nominalSize(for: textStyle)
#endif
    return Font.custom(name, size: fontSize, relativeTo: textStyle)
  }

#if os(macOS)
  // macOS: native Dynamic Type metrics differ from UIKit; use nominal iOS default point sizes.
  // swiftlint:disable:next cyclomatic_complexity
  static func nominalSize(for textStyle: SwiftUI.Font.TextStyle) -> CGFloat {
    switch textStyle {
