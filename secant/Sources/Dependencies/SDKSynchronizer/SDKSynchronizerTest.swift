...
extension SDKSynchronizerClient: TestDependencyKey {
    static let testValue = Self(
        ...
        lockMigrationDust: unimplemented("\(Self.self).lockMigrationDust"),
        migrateMigrationDust: unimplemented("\(Self.self).migrateMigrationDust", placeholder: nil),
        isMigrationDustLocked: unimplemented("\(Self.self).isMigrationDustLocked", placeholder: false),
...
extension SDKSynchronizerClient {
    static func mocked(
        ...
        prepareWith: @escaping @Sendable ([UInt8], BlockHeight?, String, String?) throws -> Initializer.InitializationResult = { _, _, _, _ in .success },
