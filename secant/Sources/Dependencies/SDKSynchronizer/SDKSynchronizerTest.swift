...
extension SDKSynchronizerClient: TestDependencyKey {
    static let testValue = Self(
        ...
        migrationProposeImmediateTransfers: unimplemented("\(Self.self).migrationProposeImmediateTransfers", placeholder: ZcashLightClientKit.MigrationSchedule(transfers: [], estimatedDurationHours: 0)),
...
extension SDKSynchronizerClient {
    static let noOp = Self(
        ...
        migrationProposeImmediateTransfers: { _ in ZcashLightClientKit.MigrationSchedule(transfers: [], estimatedDurationHours: 0) },
...
extension SDKSynchronizerClient {
    ...
    importAccount: @escaping @Sendable (String, [UInt8]?, Zip32AccountIndex?, AccountPurpose, String, String?, BlockHeight?) async throws -> AccountUUID? = { _, _, _, _, _, _, _ in nil },
        ...
        migrationProposeImmediateTransfers: @escaping @Sendable (AccountUUID) async throws -> ZcashLightClientKit.MigrationSchedule = { _ in ZcashLightClientKit.MigrationSchedule(transfers: [], estimatedDurationHours: 0) },
        ...
        SDKSynchronizerClient(
            ...
            migrationProposeImmediateTransfers: migrationProposeImmediateTransfers,
