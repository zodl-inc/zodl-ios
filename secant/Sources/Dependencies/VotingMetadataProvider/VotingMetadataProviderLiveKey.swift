...
extension VotingMetadataProviderClient: DependencyKey {
    ...
    static func live() -> Self {
        ...
        return VotingMetadataProviderClient(
            ...
            loadSubmissionIntents: { storage.loadSubmissionIntents(roundId: $0) },
            setSubmissionIntents: { storage.setSubmissionIntents($0, roundId: $1) },
            clearSubmissionIntents: { storage.clearSubmissionIntents(roundId: $0) },
            singleShareMode: { storage.singleShareMode(roundId: $0) },
            setSingleShareMode: { storage.setSingleShareMode($0, roundId: $1) },
            clearSingleShareMode: { storage.clearSingleShareMode(roundId: $0) },
