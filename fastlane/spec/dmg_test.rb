...
class ZodlDmgTest < Minitest::Test
  ...
  def test_create_dmg_command_with_volicon
    cmd = Zodl::Dmg.create_dmg_command(
      app_name: "Zodl.app", source_dir: "/s", dmg_path: "/d.dmg", volicon: "/icon.icns"
    )
